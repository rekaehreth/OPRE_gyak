...
// Output
//// Waits 3 seconds, then send a SIGUSR 30 signal (it is not waited for by suspend) - so the suspend continues waiting
//// Waits 3 seconds, the send a SIGTERM 15 signal (it is waited for by suspend)
//// Child process ended
//// Signal with number 15 has arrived
//// Signal with number 30 has arrived
